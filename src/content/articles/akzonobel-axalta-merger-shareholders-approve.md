...
<div class="callout risk">
  ...
  <ul>
    <li><strong>Antitrust remedies:</strong> Overlap in automotive refinish and select industrial segments could force asset sales that erode the strategic rationale before day one.</li>
    <li><strong>Integration complexity:</strong> Merging two geographically dispersed, culturally distinct organizations under a nominal equals structure invites leadership gridlock and talent attrition at exactly the moment execution matters most.</li>
    <li><strong>Raw-material exposure:</strong> Both companies are exposed to titanium dioxide and resin cost cycles; a macro downturn during integration could compress margins and divert management attention from synergy delivery.</li>
  </ul>
</div>
...
*Source: ["merger OR acquisition OR "takeover bid" when:2d" - Google News](https://news.google.?oc=5)*
