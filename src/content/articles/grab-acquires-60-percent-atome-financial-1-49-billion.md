---
title: "Grab Buys 60% of Atome Financial for $1.49 Billion in a Bet on Southeast Asian Consumer Lending"
subtitle: "The super-app is taking control of a buy-now-pay-later lender with 25 million cumulative users across five markets, with the remaining stake to follow about two years after the first close."
date: 2026-09-16
readTime: 4
...
**The staged structure spreads the risk.** Buying 60% now and the rest later lets Grab prove the integration and monitor loan performance before committing the full price. It also keeps Advance Intelligence invested through the transition, aligning the seller with the outcome.

<div class="callout risk">
  <div class="ttl">Risks to Watch</div>
  <ul>
    <li><strong>Credit quality:</strong> BNPL and unsecured consumer lending in emerging markets are sensitive to downturns; losses could erode the growth thesis quickly.</li>
    <li><strong>Regulatory tightening:</strong> Several Southeast Asian regulators are scrutinising BNPL; new rules on fees or caps could compress margins.</li>
    <li><strong>Long closing runway:</strong> A third-quarter-2027 completion leaves the deal exposed to market and regulatory shifts for a year.</li>
  </ul>
</div>
<div class="callout bull">
  <div class="ttl">Bull Case</div>
  <ul>
    <li><strong>Distribution advantage:</strong> Embedding Atome's products in Grab's app reaches tens of millions of users at negligible acquisition cost.</li>
    <li><strong>Higher-margin mix:</strong> Lending revenue lifts the profitability profile of a group still dominated by mobility and delivery.</li>
    <li><strong>Regional licences:</strong> Atome's footprint across five markets provides regulatory infrastructure that is hard to replicate.</li>
  </ul>
</div>


*Source: [Grab Holdings](https://investors.grab.com/news-and-events/news-details/2026/Grab-to-acquire-majority-stake-in-Atome-Financial-accelerating-growth-and-profitability-of-Financial-Services-segment-2026-DVr9ZLrZC9/default.aspx)*
