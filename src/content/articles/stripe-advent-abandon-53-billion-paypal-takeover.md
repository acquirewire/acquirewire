---
title: "Stripe and Advent Walk Away From $53 Billion PayPal Pursuit After Rally Prices Them Out"
subtitle: "A 40% run in PayPal's shares left the consortium's $60.50-a-share offer stranded; the stock fell as much as 16% premarket once the biggest leveraged buyout in years was pronounced dead."
date: 2026-08-31
readTime: 4
...
<div class="callout risk">
  ...
  <ul>
    <li><strong>Valuation air pocket:</strong> PayPal shares had priced in a bid; without one, the stock must justify its level on fundamentals in a competitive payments market.</li>
    <li><strong>Activist pressure:</strong> Having rejected $60.50, the board will face scrutiny if the stock settles materially below that level for an extended period.</li>
    <li><strong>Strategic drift:</strong> Months of takeover speculation can distract management and slow product decisions at a company already facing share loss to newer rivals.</li>
  </ul>
</div>
<div class="callout bull">
  <div class="ttl">Bull Case</div>
  <ul>
    <li><strong>Board discipline validated:</strong> Holding out for a higher price forced the market to reassess PayPal's intrinsic value upward.</li>
    <li><strong>Optionality remains:</strong> A stronger share price and demonstrated buyer interest keep PayPal in play for a strategic acquirer with cheaper capital.</li>
    <li><strong>Standalone catalysts:</strong> Freed from deal limbo, management can execute on turnaround initiatives without an overhang.</li>
  </ul>
</div>


*Source: [Bloomberg](https://www.bloomberg.com/news/articles/2026-08-28/advent-stripe-consortium-is-said-to-drop-pursuit-of-paypal)*
