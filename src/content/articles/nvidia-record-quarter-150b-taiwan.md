---
title: "Nvidia Just Did $81.6B in a Quarter and Said It Will Spend $150B in Taiwan a Year"
subtitle: "Record Q1 revenue up 85%. Data center revenue up 92%. An additional $80B buyback authorization. And a 10x increase in Taiwan spending. Huang called the AI buildout \"the largest infrastructure expansion in human history.\" The numbers back him up."
date: 2026-05-27
readTime: 5
...
<div class="callout risk">
  ...
  <ul>
    <li><strong>Demand visibility:</strong> Multi-year cloud service commitments reached $30 billion. If hyperscaler capex peaks, the deceleration would be steep.</li>
    <li><strong>Taiwan concentration:</strong> $150B in annual spending in one geographic region creates supply chain fragility if cross-Strait tensions escalate.</li>
    <li><strong>Community pushback:</strong> $41.7B in data center projects were canceled in Q1 2026 alone due to local opposition. Power, water, and grid constraints are real.</li>
  </ul>
</div>
...
<div class="callout bull">
  ...
  <ul>
    <li><strong>Sovereign AI demand:</strong> A new buyer category at national scale, with multi-year procurement budgets and minimal price sensitivity. This base did not exist 18 months ago.</li>
    <li><strong>Q2 guide implies acceleration:</strong> $91B is a 12% sequential increase off a record quarter. Growth is not flatlining.</li>
    <li><strong>Capital return inflection:</strong> The 25x dividend hike and $80B buyback signal management's view that the cash generation profile is structural, not cyclical.</li>
  </ul>
</div>
